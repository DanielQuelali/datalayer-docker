...
docker rm -f zeppelin-r > /dev/null 2>&1
...
sudo docker run \
    ...
    -h zeppelin-r.datalayer.io.local \
    --privileged \
    --name zeppelin-r \
    --entrypoint=/opt/zeppelin/bin/zeppelin-r.sh \
    datalayer/zeppelin-r "$@"
