...
objectclass: organizationalUnit
EOF
ldapadd -a -c -f ~/initial-dit.ldif -H ldap://docker.datalayer.io:389 -D "cn=Manager,dc=datalayer,dc=io" -w secret
...
EOF
ldapadd -a -f /tmp/ldap-group-add.ldif -H ldap://docker.datalayer.io:389 -D "cn=Manager,dc=datalayer,dc=io" -w secret
...
ldapadd -a -f /tmp/ldap-user-add.ldif -H ldap://docker.datalayer.io:389 -D "cn=Manager,dc=datalayer,dc=io" -w secret

authconfig --enableldap  \
           --enableldapauth  \
           --ldapserver=ldap://docker.datalayer.io:389 \
...
# ldapsearch -x -H ldap://docker.datalayer.io:389 -b dc=datalayer,dc=io "(cn=datalayer)"
# ldapsearch -x -H ldap://docker.datalayer.io:389 -b dc=datalayer,dc=io "(uid=datalayer)"
